        ...
        <View style={{ paddingHorizontal: 20, marginBottom: 24 }}>
          ...
          >
            ...
            <View style={{ flexDirection: "row", gap: 12 }}>
              <AnimatedPressable
                onPress={() => {
                  console.log("[Nav] Opening deposit modal");
              ...
              >
                <Text style={{ color: "#FFFFFF", fontSize: 14, fontWeight: "700", fontFamily: "Nunito_700Bold" }}>
                  Déposer
                </Text>
              </AnimatedPressable>
              <AnimatedPressable
                onPress={() => {
                  console.log("[Nav] Opening send modal");
          ...
          {loading ? (
            ...
            <View style={{ paddingHorizontal: 20 }}>
              <View style={{ backgroundColor: COLORS.surface, borderRadius: 16, padding: 20, alignItems: "center", borderWidth: 1, borderColor: COLORS.border }}>
                <Text style={{ color: COLORS.textSecondary, fontFamily: "Nunito_400Regular", fontSize: 14 }}>
              ...
              {contributions.map((c, i) => {
                ...
                return (
                  <AnimatedListItem key={c.id} index={i}>
                    ...
                    >
                      <Text numberOfLines={1} style={{ fontSize: 13, fontWeight: "600", color: COLORS.textSecondary, fontFamily: "Nunito_600SemiBold", marginBottom: 6 }}>
                        {c.groupName}
                      </Text>
                      <Text style={{ fontSize: 20, fontWeight: "800", color: COLORS.text, fontFamily: "Nunito_800ExtraBold", marginBottom: 4 }}>
                        {formatGNF(c.amount)}
                      </Text>
                      ...
                      <AnimatedPressable
                        onPress={() => {
                          console.log("[Nav] Opening pay contribution for group", c.groupId);
                          router.push({ pathname: "/contribution/pay", params: { groupId: c.groupId, contributionId: c.id } });
                        }}
                        style={{
                          backgroundColor: COLORS.primary,
                          borderRadius: 10,
                      ...
                      >
                        <Text style={{ color: "#FFFFFF", fontSize: 13, fontWeight: "700", fontFamily: "Nunito_700Bold" }}>
                          Payer
                        </Text>
                      </AnimatedPressable>
                    </View>
        ...
        <View style={{ marginBottom: 24, paddingHorizontal: 20 }}>
          <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
            ...
            <AnimatedPressable onPress={() => router.push("/(tabs)/(groups)")}>
              <View style={{ flexDirection: "row", alignItems: "center", gap: 4 }}>
                <Text style={{ fontSize: 13, color: COLORS.primary, fontFamily: "Nunito_600SemiBold" }}>
                  Voir tout
                </Text>
          ...
          {loading ? (
            ...
            <EmptyState
              ...
              subtitle="Rejoignez ou créez votre première tontine pour commencer à épargner"
              ctaLabel="Créer une tontine"
              onCta={() => {
                console.log("[Nav] Opening create group modal");
              ...
              {groups.slice(0, 3).map((g, i) => {
                ...
                return (
                  <AnimatedListItem key={g.id} index={i}>
                    <AnimatedPressable
                      onPress={() => {
                        console.log("[Nav] Navigating to group", g.id);
                    ...
                    >
                      ...
                      >
                        ...
                        <View style={{ flex: 1 }}>
                          <Text numberOfLines={1} style={{ fontSize: 15, fontWeight: "700", color: COLORS.text, fontFamily: "Nunito_700Bold", marginBottom: 3 }}>
                            {g.name}
                          </Text>
                          <Text style={{ fontSize: 13, color: COLORS.textSecondary, fontFamily: "Nunito_400Regular", marginBottom: 6 }}>
                            {formatGNF(g.contributionAmount)} · {freqLabel} · {g.memberCount} membres
                          </Text>
                          <View style={{ flexDirection: "row", gap: 6 }}>
                            ...
                            <View style={{ backgroundColor: COLORS.accentMuted, borderRadius: 6, paddingHorizontal: 6, paddingVertical: 2 }}>
                              <Text style={{ fontSize: 10, fontWeight: "700", color: COLORS.accent, fontFamily: "Nunito_700Bold" }}>
                                {g.myRole === "admin" ? "Admin" : g.myRole === "treasurer" ? "Trésorier" : "Membre"}
                              </Text>
                            </View>
                          </View>
                        </View>
                ...
                return (
                  <AnimatedListItem key={tx.id} index={i}>
                    ...
                    >
                      ...
                      <View style={{ flex: 1 }}>
                        <Text numberOfLines={1} style={{ fontSize: 14, fontWeight: "600", color: COLORS.text, fontFamily: "Nunito_600SemiBold" }}>
                          {tx.description}
                        </Text>
                        <Text style={{ fontSize: 12, color: COLORS.textTertiary, fontFamily: "Nunito_400Regular" }}>
                          {dateStr}
